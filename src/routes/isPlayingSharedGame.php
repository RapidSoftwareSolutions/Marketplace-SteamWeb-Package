<?php
$app->post('/api/SteamWeb/isPlayingSharedGame', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "IPlayerService/IsPlayingSharedGame/" . $version . '/';
    $body['steamid'] = $post_data['args']['steamId'];
    $body['key'] = $post_data['args']['apiKey'];
    $body['appid_playing'] = $post_data['args']['appId'];
