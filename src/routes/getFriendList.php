<?php
$app->post('/api/SteamWeb/getFriendList', function ($request, $response, $args) {
    ...
    if (isset($post_data['args']['relationship']) && strlen($post_data['args']['relationship']) > 0) {
        $body['relationship'] = $post_data['args']['relationship'];
    }
    ...
    try {
        ...
        $result['callback'] = 'error';
        $result['contextWrites']['to'] = $post_data;
