<?php
$app->post('/api/SteamWeb/getPlayerAchievements', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "ISteamUserStats/GetPlayerAchievements/" . $version . '/';
    ...
    if (isset($post_data['args']['language']) && strlen($post_data['args']['language']) > 0) {
        $body['l'] = $post_data['args']['language'];
    }
