<?php
$app->post('/api/SteamWeb/getNumberOfCurrentPlayers', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "ISteamUserStats/GetNumberOfCurrentPlayers/" . $version . '/';
